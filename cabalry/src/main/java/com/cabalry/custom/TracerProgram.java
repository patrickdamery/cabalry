...
public class TracerProgram {
    ...
    private TracerListener tracerListener;
    ...
    public TracerProgram(Context context, TracerListener tracerListener) {
    ...
    private void updateLocation(Location location) {
        ...
        tracerListener.onUpdateLocation(currentBestLocation);
    }
