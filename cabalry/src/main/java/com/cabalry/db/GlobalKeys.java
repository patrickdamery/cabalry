...
public class GlobalKeys {
    ...
    public static final String CHECKPASS_URL = "http://"+CABALRY_IP+"/cabalry/checkPassword.php";
    public static final String ALARM_URL = "http://"+CABALRY_IP+"/cabalry/alarm.php";
    public static final String ALARMLIST_URL = "http://"+CABALRY_IP+"/cabalry/alarmList.php";
    public static final String ALARMINFO_URL = "http://"+CABALRY_IP+"/cabalry/alarmInfo.php";
    public static final String ALARMIGNORE_URL = "http://"+CABALRY_IP+"/cabalry/ignore.php";
